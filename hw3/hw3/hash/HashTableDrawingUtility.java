...
public class HashTableDrawingUtility {
    ...
    public static void setScale(double sf) {
        // Sets the scaling factor for the drawing. Set to numbers 
        // less than 1 to fit more stuff on the screen. 
        scalingFactor = sf;
    }

    public static double xCoord(int bucketPos) {
        // Returns the StdDraw X coodinate of an item at 
    ...
    public static double yCoord(int bucketNum, int M) {
        // Returns the StdDraw Y coordinate of an item in
    ...
    public static void drawLabels(int M) {
        // Draws numerical labels for each bucket, where M
